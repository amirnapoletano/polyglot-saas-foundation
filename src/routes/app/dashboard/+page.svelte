...
<div class="space-y-8">
		...
		<Card>
			...
			<div class="mt-2 flex items-center gap-2">
				...
				<Badge variant={data.plan === 'pro' ? 'brand' : 'default'}
					>{data.isActive ? 'Active' : 'Inactive'}</Badge
				>
			</div>
		</Card>
		...
		<Card>
			...
			<div class="mt-2">
				<span class="text-2xl font-bold text-text-primary capitalize"
					>{(data.org as any)?.role ?? 'member'}</span
				>
			</div>
		</Card>
	...
	<div>
		...
		<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
			<a
				href="/app/members"
				class="group rounded-xl border border-border bg-surface p-5 hover:shadow-md transition-all"
			>
				<div class="flex items-center gap-3">
					<div
						class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-50 text-brand-600 group-hover:bg-brand-100 transition-colors"
					>
						<svg
							class="h-5 w-5"
							fill="none"
			...
			>
				<div class="flex items-center gap-3">
					<div
						class="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 group-hover:bg-emerald-100 transition-colors"
					>
						<svg
							class="h-5 w-5"
							fill="none"
			...
			>
				<div class="flex items-center gap-3">
					<div
						class="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-50 text-amber-600 group-hover:bg-amber-100 transition-colors"
					>
						<svg
							class="h-5 w-5"
							fill="none"
